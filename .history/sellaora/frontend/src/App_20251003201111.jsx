...
function HomePage() {
  ...
  const [newStore, setNewStore] = useState({ storeName: "" });
  ...
  return (
    <Router>
        <Routes>
         ...
         <Route path="/dashboard" element={<Dashboard newStore={newStore} setNewStore={setNewStore} />} />
         <Route path="/editor" element={<Editor storeName={newStore.storeName} />} />
      </Router>
  )
}
export default App